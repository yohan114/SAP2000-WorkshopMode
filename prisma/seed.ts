...
async function assignRolePrivileges() {
  ...
  const rolePrivilegeMap: Record<string, string[]> = {
    ...
    'SUPERVISOR': ['JC_CREATE', 'JC_VIEW', 'JC_EDIT', 'JC_APPROVE', 'JC_CLOSE', 'MR_CREATE', 'MR_VIEW', 'MR_APPROVE', 'MI_VIEW', 'INV_VIEW', 'ASSET_VIEW', 'ASSET_CREATE', 'REPORT_VIEW'],
    ...
    'WM': ['JC_CREATE', 'JC_VIEW', 'JC_EDIT', 'JC_APPROVE', 'JC_CLOSE', 'JC_CANCEL', 'MR_CREATE', 'MR_VIEW', 'MR_APPROVE', 'MI_CREATE', 'MI_VIEW', 'INV_VIEW', 'INV_MANAGE', 'PR_CREATE', 'PR_APPROVE_L1', 'PR_APPROVE_L2', 'PO_CREATE', 'PO_APPROVE', 'GRN_CREATE', 'LP_CHANNEL_OVERRIDE', 'ASSET_CREATE', 'ASSET_VIEW', 'REPORT_VIEW'],
    ...
    'ADMIN': ['JC_CREATE', 'JC_VIEW', 'JC_EDIT', 'JC_APPROVE', 'JC_CLOSE', 'JC_CANCEL', 'JC_MULTI_OPEN', 'MR_CREATE', 'MR_VIEW', 'MR_APPROVE', 'MI_CREATE', 'MI_VIEW', 'MI_VERIFY', 'INV_VIEW', 'INV_MANAGE', 'PR_CREATE', 'PR_APPROVE_L1', 'PR_APPROVE_L2', 'PO_CREATE', 'PO_APPROVE', 'GRN_CREATE', 'GRN_VERIFY', 'LP_CHANNEL_OVERRIDE', 'SYS_LPA_OVERRIDE', 'ASSET_CREATE', 'ASSET_VIEW', 'USER_MANAGE', 'ROLE_MANAGE', 'AUDIT_VIEW', 'REPORT_VIEW'],
  };
