 ...
 *         schema:
 *           type: string
 *         description: Search term for asset number, name, make, or model
 *       - in: query
 *         name: sortBy
 *         schema:
 *           type: string
 ...
 *     description: Create a new asset with the provided details. A QR code is automatically generated for the asset.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                     qrCode:
 *                       type: string
 *                       description: Generated QR code for the asset
 *       400:
 *         description: Validation error or asset number already exists
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
